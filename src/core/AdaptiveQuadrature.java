...
public strictfp class AdaptiveQudrature extends Maths {
    ...
    public static void main(String args[]) throws FunctionOneVariable.UndefinedVariableException, InsufficientDataPointsException, UnequalSpacedDataPointsException {
        NewtonCotesQuadrature ncqa = new NewtonCotesQuadrature();
        FunctionOneVariable toIntegerate = new FunctionOneVariable("( 0 + sqrt ( x ) )");
        //System.out.println(ncqa.integrate());
        ncqa.setDataPoints(new Double[]{0.0, 1.0,2.0,3.0}, toIntegerate);
        //System.out.println(Arrays.toString(ncqa.datay));
        System.out.println(ncqa.integrate());
    }
}
